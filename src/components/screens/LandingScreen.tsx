  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <button
          onClick={onNext}
          className="flex items-center space-x-3 px-5 py-1 rounded-xl border border-[#f8bee4] text-primary font-medium mt-10 cursor-pointer bg-white shadow-[0_0_5px_rgba(255,107,181,0.3),0_2px_5px_rgba(255,107,181,0.18)] transition-all duration-300"
        >
      ...
      <span className="text-center mt-4 px-4 text-[#eb1d84] !font-light">
